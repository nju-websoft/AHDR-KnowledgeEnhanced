common_dict_config = {
    ...
    'embedding_method': 'wikidata_rdf2vec_sg_200_1',  # 'wikidata_rdf2vec_sg_200_1', #'wiki2vec', # 'dbpedia_rdf2vec_sg_500' #kgtk
    'test_collection_name': 'ACORDAR', # 'ACORDAR|NTCIR-E|ntcir16'
    # 'test_version': 15, # for ntcir
    'train_or_test': 'test',
    'data_field': 'metadata', # 'metadata|content|all' , 'illusnip'   
    'res_dir_name': 'multi_run', # 'multi_run_dense_sparse_weight_with_confidence_margin1_2', # 
    # 'res_dir_name': 'multi_run_qdweight_margin_2',
    'k': 10, # rerank top k
}
# link_res_dir_path = f"/home/yourname/code/erm/data/anno_falcon_files/{common_dict_config['test_collection_name']}/"
link_res_dir_path = f"/home/yourname/code/erm/data/anno_rel_files/ntcir16/query/"
# common_dict_config['multi_run_dir_name'] = f'unsupervised/2/' # f'multi_run_dense_sparse_weight_1/'

sparse_methods = ['BM25', 'FSDM', 'LMD', 'TFIDF'] if common_dict_config['test_collection_name'] == 'ACORDAR' else ['BM25']
if common_dict_config['data_field'] == 'metadata':
    method_suffix = ' [m]'
elif common_dict_config['data_field'] == 'content':
    method_suffix = ' [d]'
else: method_suffix = ' [a]'
sparse_methods = [method + method_suffix for method in sparse_methods]


# 'file_texts_path': '/home/yourname/code/erm/data/ntcir_file/v2/text_full_other_format'
# link_res_dir_path = f'/home/yourname/code/erm/data/annos/{test_collection_name}/annos_other_fmt_{link_method}'
...
retrieve_dict_config = {
    ...
    'filter_link_pb_lb': 0, # 0.010885492898523808,
    'filter_link_pb_ub': 1,
    'filter_rho_lb': 0,
    'filter_rho_ub': 1,
    ...
    'entity_sim_df_lb': 0, # 0.55, # 0.8,
    'entity_sim_tf_lb': 0, # 0.525, # 0.5    
}
"""
score_op notes:
...
eval_dict_config = {
    ...
    'link_pb_lb': 0, # 0.03084646910429001 
    'link_pb_ub': 1, # 0.1316455751657486
    'rho_lb': 0, # 0.21573256887495518
    'rho_ub': 1, # 0.8423898220062256
    'len_one_check': False, # False,
    'metadata_tokens_len_lb': 0, # 100,
...
def check_retrieve_config(retrieve_dict_config):
    ...
    # assert retrieve_dict_config['use_word_embedding'] == False or 
